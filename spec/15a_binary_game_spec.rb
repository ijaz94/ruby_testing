...
describe BinaryGame do
  ...
  describe '#player_input' do
    ...
    context 'when user inputs an incorrect value once, then a valid input' do
      before do
        ...
        # The first time the user inputs a letter, the loop will continue.
        # The second time the user inputs a number, the loop will stop.
        # The loop will stop when the valid_input is between?(min, max)
      end
    ...
    context 'when user inputs two incorrect values, then a valid input' do
      before do
        ...
        invalid_input_two = '!'
        valid_input = '3'
        allow(game_input).to receive(:gets).and_return(invalid_input, invalid_input_two, valid_input)
        # The first time the user inputs a letter, the loop will continue.
        # The second time the user inputs a symbol, the loop will continue.
        # The third time the user inputs a number, the loop will stop.
        # The loop will stop when the valid_input is between?(min, max)
      end
  ...
  describe '#verify_input' do
    ...
    context 'when given a valid input as argument' do
      it 'returns valid input' do
        ...
        max = 10
        valid_input = 3
        game_verify = described_class.new(min, max)
        result = game_verify.verify_input(min, max, valid_input)
        expect(result).to eq(valid_input)
        # The result will be the same as the valid_input.
      end
    end
    ...
    context 'when given invalid input as argument' do
      it 'returns nil' do
        ...
        invalid_input = 15
        game_verify = described_class.new(min, max)
        result = game_verify.verify_input(min, max, invalid_input)
        expect(result).to be_nil
        # The result will be nil because the input is not between?(min, max).
      end
    end
  end
  ...
  describe '#maximum_guesses' do
    ...
    context 'when game minimum and maximum is 100 and 600' do
      ...
      # The maximum guesses should be 9.
      it 'returns 9' do
  ...
  describe '#display_binary_search' do
    ...
    context 'when game_over? is false five times' do
      ...
      it 'calls display_turn_order five times' do
        ...
        game_display.display_binary_search(search_display)
        # The method will be called five times before game_over? returns true.
      end
    end
  end
  ...
  describe '#display_turn_order' do
    ...
    it 'increases guess_count by one' do
      ...
      # The guess_count will increase by one.
    end
    ...
    it 'sends make_guess' do
      ...
      # The make_guess method will be called.
    ...
    it 'sends update_range' do
      ...
      game_turn.display_turn_order(binary_search_turn)
      # The update_range method will be called.
      # The method will be called once.
    end
