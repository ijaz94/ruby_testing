...
describe Cat do
  ...
  subject(:persian) { described_class.new('persian', 'persian cat', 'white') }
  # Write a test using the second shared_example to test that cat responds to
  # talk ('meow').
  context 'when testing the talk method' do
    include_examples 'shared method name'
  end

  # remove the 'x' before running this test
  it 'is not hungry' do
    expect(persian).to_not be_hungry
  end

  # remove the 'x' before running this test
  it 'is hiding' do
    expect(persian).to be_hiding
  end
end
